...
package os_arch is
  ...
  --
   ...
   procedure os_arch_context_switch (prev_id : os.os_task_id_t; next_id : os.os_task_id_t);
   ...
   procedure os_arch_space_switch (old_context_id : os.os_task_id_t; new_context_id : os.os_task_id_t);
