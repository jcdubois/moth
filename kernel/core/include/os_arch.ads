...
package os_arch is
   ...
   function interrupt_is_pending return types.uint8_t with
      Global => null;
   ...
   procedure context_create (task_id : Moth.os_task_id_param_t) with
      Global => null;
   ...
   procedure space_switch
     (old_context_id : Moth.os_task_id_param_t;
      new_context_id : Moth.os_task_id_param_t) with
      Global => null;
   pragma Import (C, space_switch, "os_arch_space_switch");

   procedure cons_init with
      Global => null;
